			...
			<div className="bg-black border-2 border-red-600 rounded-lg p-4 max-w-sm shadow-2xl relative">
				<div className="space-y-3">
					<div className="flex items-center justify-between">
						<div className="w-fit h-fit bg-gradient-to-br from-rose-500 via-pink-300 to-red-800 rounded-lg p-1">
							<svg
							...
							>
								<path
									fill="currentColor"
									d="M8 22L5 8l3-6h8l3 6l-3 14zm3-16v2H9v2h2v5h2v-5h2V8h-2V6z"
								></path>
							</svg>
						</div>
