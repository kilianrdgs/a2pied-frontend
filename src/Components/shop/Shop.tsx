...
export default function Shop() {
	...
	const { points, removePoints, setPoints, loadCreditsFromBackend } =
		usePointsStore();
	const { getUserUpgrades, getAvailablesUpgrades } = useUpgradesStore();
			...
			<main className="shop-main">
				...
				>
					...
					<div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
						<MobsGrid mobs={mobs} onMobClick={handleClick} />
					</div>
				</div>
			</main>
		</div>
