...
export function MobCard({mob, onMobClick}: Props) {
    ...
    return <div className="bg-black p-4 border border-red-200 rounded-lg flex flex-col items-start justify-between">
        <div className="space-y-2 flex flex-col items-start">
            <div className="bg-red-200/20 p-2 rounded-full mx-auto"><img
                src={imgSrc}
                alt={mob.name}
